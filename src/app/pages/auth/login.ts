...
@Component({
    selector: 'app-login',
    standalone: true,
    imports: [ButtonModule, CheckboxModule, InputTextModule, PasswordModule, FormsModule, RouterModule, RippleModule, AppFloatingConfigurator, AppLogo, Message, NgIf, ReactiveFormsModule],
    template: `
                        ...
                        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
                            <div>
                                ...
                                <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                    <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary" routerLink="/register">Don't have an account?</span>
                                ...
                                <p-button label="Login" type="submit" styleClass="w-full" [disabled]="loginForm.invalid"></p-button>
